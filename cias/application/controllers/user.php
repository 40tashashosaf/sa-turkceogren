...
class User extends CI_Controller
{
    ...
    function changePassword()
    {
        ...
        else
        {
            ...
            if(empty($resultPas))
            {
                $this->session->set_flashdata('nomatch', 'Eski Şifreniz Hatalı');
            ...
            else
            {
                ...
                if($result > 0) { $this->session->set_flashdata('success', 'Şifre Güncellendi'); }
                else { $this->session->set_flashdata('error', 'Şifre Güncellenemedi'); }
