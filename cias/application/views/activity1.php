...
<link rel="stylesheet" type="text/css" href="https://use.fontawesome.com/releases/v5.9.0/css/all.css">
  ...
  <section class="droppable-elements">
    <div class="droppable" data-draggable-id="frog"><span>Kurbağa</span></div>
    <div class="droppable" data-draggable-id="dove"><span>Kuş</span></div>
    <div class="droppable" data-draggable-id="cat"><span>Kedi</span></div>
    <div class="droppable" data-draggable-id="fish"><span>Balık</span></div>
    <div class="droppable" data-draggable-id="dog"><span>Köpek</span></div>
